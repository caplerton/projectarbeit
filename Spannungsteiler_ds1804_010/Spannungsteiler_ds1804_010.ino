...
#define sensor0 8 // anliegender Sensor0.
#define sensor1 9 // anliegender Sensor1.
#define sensor2 10 // anliegender Sensor2.
#define reference 11
...
float update_resistance(float dest){
...
void loop() {
  update_resistance(2800);
  Serial.println(calculate_resistance());
  update_resistance(5500);
  Serial.println(calculate_resistance());
  update_resistance(1500);
  change_ground(sensor2);
  Serial.println(calculate_sensor( calculate_resistance()));
}
